	...
	<section class="login-block">
		...
		<div class="row">
			<div class="col-md-12 login-sec">
			    <h2 class="text-center">Đăng ký Admin</h2>
	<form class="login-form" action="XulyRegiterAdmin.php" method="POST" onsubmit="return validateRes()">
	  ...
	  <div>
	    <button type="submit" class="btn btn-login  btn-block"name="btn_regiteradmin">Đăng ký</button>
	  </div>
	  
	</form>
	<div>
		<br>
		<a href="formloginadmin.php" title="">Trở về đăng nhập</a>

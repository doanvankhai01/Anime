...
<body>
	<section class="login-block">
		...
		<div class="row">
			<div class="col-md-12 login-sec">
			    <h2 class="text-center">Đăng nhập Admin</h2>
                            <form class="login-form" id="login-form" action="Xulyloginadmin.php" method="POST" onsubmit="return validateLogin()">
	  ...
	  <div class="form-group">
	    ...
	    <button type="submit" class="btn btn-login float-right" name="btn_DangNhapAdmin">Đăng Nhập</button>
	  </div>
	  
	</form>
	<div>
		<br>
		<p>Bạn chưa có tài khoản<a href="formregiteradmin.php" title=""> Đăng ký</a></p>

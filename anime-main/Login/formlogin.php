...
<body>
	<section class="login-block">
		...
		<div class="row">
			<div class="col-md-12 login-sec">
			    <h2 class="text-center">Đăng nhập User</h2>
                            <form class="login-form" id="login-form" action="Xulyloginform.php" method="POST" onsubmit="return validateLogin()">
	  ...
	  <div class="form-group">
	    ...
	    <button type="submit" class="btn btn-login float-right" name="btn_DangNhapUser">Đăng Nhập</button>
	  </div>
